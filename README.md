...
First, make sure you have built [eIDAS-Node](https://ec.europa.eu/digital-building-blocks/sites/spaces/DIGITAL/pages/967117149/eIDAS-Node+version+3.1.0) artifacts and installed these to the local Maven repository:
```
