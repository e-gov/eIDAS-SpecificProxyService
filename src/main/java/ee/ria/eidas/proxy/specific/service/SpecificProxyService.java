...
public class SpecificProxyService {
    ...
    private final Cache<String, ILightResponse> specificMSIdpConsentCorrelationMap;
     ...
     * @param consentedIlightRequest the resulting light request that only contains the consentBinaryLightToken attributes
    ...
    private void storeBinaryTokenLightResponse(String id, ILightResponse iLightResponse) {
        specificMSIdpConsentCorrelationMap.put(id, iLightResponse);
    }
    ...
    private ILightResponse getRemoveBinaryTokenResponse(String id) {
        final ILightResponse iLightResponse = specificMSIdpConsentCorrelationMap.get(id);
        if (null != iLightResponse) {
            specificMSIdpConsentCorrelationMap.remove(id);
        }
